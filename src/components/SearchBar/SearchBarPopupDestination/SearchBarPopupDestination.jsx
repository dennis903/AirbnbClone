...
function SearchBarPopupDestination() {
	...
	const handleClickArrowBtn = (direction) => {
		if (direction === 'right') {
		...
		<div className={cx('searchbar-popup')}>
			...
			<div className={cx('searchbar-popup__section')}>
				<nav className={cx('worldwide-nav')}>
					{!isLeftDisabled && <div className={cx('worldwide-arrow', 'worldwide-arrow--left')} onClick={() => handleClickArrowBtn('left')}>
						<ArrowLeft />
					</div>}
					<ul ref={scrollRef} className={cx('worldwide-list')} onScroll={handleScroll}>
						...
						<li className={cx('worldwide-item', {
							'worldwide-item--selected': selectedContinent === 'easeAsia'
					...
					{!isRightDisabled && <div className={cx('worldwide-arrow', 'worldwide-arrow--right')} onClick={() => handleClickArrowBtn('right')}>
						<ArrowRight />
					</div>}
				</nav>
